...
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I /home/ahmed/.local/lib/python3.6/site-packages/tensorflow_core/include -I /usr/local/cuda-10.0/include -I /home/ahmed/.local/lib/python3.6/site-packages/tensorflow_core/include/external/nsync/public -lcudart -L  /usr/local/cuda-10.0/lib64/ -L/home/ahmed/.local/lib/python3.6/site-packages/tensorflow_core  -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0