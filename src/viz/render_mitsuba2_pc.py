...
PATH_TO_MITSUBA2 = "/home/ahmed/mitsuba2/build/dist/mitsuba"  # mitsuba exectuable
...
def main(argv):
    ...
    #for pcli in range(0, render_object_n):
    for pcli in [1, 3, 7, 10, 16, 23, 26, 27, 30]:
        pcl = pclTime[pcli, :, :]
